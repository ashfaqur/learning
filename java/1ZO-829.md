...
- [Exam Topics](#exam-topics)
  - [Handling date, time, text, numeric and boolean values](#handling-date-time-text-numeric-and-boolean-values)
  - [Controlling Program Flow](#controlling-program-flow)
  - [Utilizing Java Object-Oriented Approach](#utilizing-java-object-oriented-approach)
  - [Handling Exceptions](#handling-exceptions)
  - [Working with Arrays and Collections](#working-with-arrays-and-collections)
  - [Working with Streams and Lambda expressions](#working-with-streams-and-lambda-expressions)
  - [Packaging and deploying Java code and use the Java Platform Module System](#packaging-and-deploying-java-code-and-use-the-java-platform-module-system)
  - [Managing concurrent code execution](#managing-concurrent-code-execution)
  - [Using Java I/O API](#using-java-io-api)
  - [Accessing databases using JDBC](#accessing-databases-using-jdbc)
  - [Implementing Localization](#implementing-localization)
  - [Assume the following:](#assume-the-following)
  - [Candidates are also expected to:](#candidates-are-also-expected-to)
